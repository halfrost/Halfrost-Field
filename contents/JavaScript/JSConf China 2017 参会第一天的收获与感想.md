...
全场听下来，收获最多的可能就是尤大讲的吧，其他的讲师不是讲的有点泛，就是来推广产品和 repo 的，其实仔细把文档看一遍，源码看一遍，收获可能比大神讲一遍，收获更多吧。

前端虽然近几年发展突飞猛进，“魔爪”向前伸向了客户端，向后伸向的后端，向下伸向了硬件，看似无所不能。但是前端依旧还有很多可以改进的地方，比如 JS 的 Class，多线程。这些都可以像面向对象的语言学习。前端工程化也可以慢慢考虑编译期优化了，这块对于客户端开发语言，天生就是编译语言来说，可以学习的优化点也挺多的。