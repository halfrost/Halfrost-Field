...
- (NSString *)_registerModule:(NSString *)name withClass:(Class)clazz
{
    ...
    NSLog(@"模块_moduleMap = %@ config.name = %@,config.clazz = %@,config.asyncMethods = %@,config.syncMethods = %@",_moduleMap,config.name,config.clazz,config.asyncMethods,config.syncMethods);
