                  ...
                  data:(id)data
{
    ...
    NSLog(@"创建instance self.instanceIdStack = %@ , instance = %@",self.instanceIdStack,instance);
    
    __weak typeof(self) weakSelf = self;
    WXPerformBlockOnBridgeThread(^(){
        
        
        NSLog(@"在JS线程中执行操作 Instance = %@, template =  %@, options =  %@, data =  %@",instance,temp,options,data);
